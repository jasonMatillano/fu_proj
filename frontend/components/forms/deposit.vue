<template>
	<b-form @submit.prevent="submit">
		<b-form-group horizontal
		            ...
		            label-for="input_sm"
		            class="mb-1">
			<b-form-input size="sm" v-model="localData.deposit_class.name" v-if="localData.deposit_class"></b-form-input>
		</b-form-group>
		<b-form-group horizontal
		            :label-cols="4"
		            label-size="sm"
		...
		<b-form-group horizontal
		            ...
		            label-for="input_sm"
		            class="mb-1">
			<b-form-input size="sm" v-model="localData.debit.name" v-if="localData.debit"></b-form-input>
		</b-form-group>
		<b-form-group horizontal
		            :label-cols="4"
		            label-size="sm"
		            ...
		            label-for="input_sm"
		            class="mb-1">
			<b-form-input size="sm" v-model="localData.credit.name" v-if="localData.credit"></b-form-input>
		</b-form-group>
...
<script lang="ts">
	...
	export default class Warehouse extends Vue {
		...
		submit(){
			this.$emit('submit', {data: this.localData,"type" : "deposit"})
		}
		clickCancel(){
