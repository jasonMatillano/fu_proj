...
public class ProductClassificationItemServiceRepo 
	...
	public List<ProductClassificationItem> 
		...
		return dao.getProductsByClassificationItemNameOrCode(classificationId, key, index);
	}

	@Override
	public Optional<ProductClassificationItem> getUndeletedProductClassificationItemByCode(String code) {
		return dao.getUndeletedProductClassificationItemByCode(code);
	}
